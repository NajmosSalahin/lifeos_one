...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {features.map(f => {
            ...
            return (
              <div key={f.title} className="card-panel hover:border-primary/30 transition cursor-default">
      ...
      <footer className="text-center py-6 border-t border-app">
        <p className="text-xs text-muted">Zenith Tracker <span className="font-mono text-primary">v1.0.0</span></p>
      </footer>
    </div>
  )
}
