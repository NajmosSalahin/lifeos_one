...
export default function ProfileMenu({ onClose }) {
  ...
  return (
    <>
      ...
      <div className="absolute top-full right-4 mt-1 z-50 bg-surface border border-app rounded-2xl shadow-xl overflow-hidden min-w-[180px]" onClick={e => e.stopPropagation()}>
